...
class TestPlayers {
	...
	@Test
	void testPlayerNumberGetterSetter() {
		Players player = new Players();
	...
	@Test
	void testPlayerLocationGetterSetter() {
		Players player = new Players();
	...
	@Test
	void testPlayerAgencyGetterSetter() {
		Players player = new Players();
	...
	@Test
	void testNumberDevelopmentsGetterSetter() {
		Players player = new Players();
